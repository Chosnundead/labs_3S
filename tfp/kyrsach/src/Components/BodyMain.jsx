          ...
          >
            ...
            <Col flex="auto">
              <Text>
                ...
                водостоков, крыш, кровель и открытых площадок, системы стаивания
                снега и льда на крышах, в водосточных и сливных трубах,
                дорожках, лестницах, террасах, балконах, пандусах, эстакадах и
                иных открытых площадках.
              </Text>
            </Col>
          </Row>
          <Row className="margin-between-content" gutter={[24, 24]}>
            <Col span={8}>
            ...
            <Col span={8}>
              ...
              <Text>
                ...
                itaque aut ad! Maxime accusantium quas illo veniam natus nobis,
                autem dolores provident quae repellendus. Quod unde numquam
                magnam. Sequi, pariatur.
              </Text>
            </Col>
            <Col span={8}>
              ...
              <Text>
                ...
                Pariatur, voluptas dolore. Similique maxime deserunt voluptatem
                natus id perferendis, qui beatae sed, obcaecati quisquam ea
                quis, corrupti nam possimus. Dolor, obcaecati?
              </Text>
            </Col>
          </Row>
        </div>
