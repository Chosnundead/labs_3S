...
db.forceFetch(
    ...
    select * from dbo.FTovCena(NULL, NULL);
     select * from dbo.FTovCena('Стул'
    , NULL);
     select * from dbo.FTovCena(NULL, 400);
     select * from dbo.FTovCena('Шкаф'
    , 340);
    """,
)
db.forceFetch(
    ...
    GO
    select Заказчик, dbo.FKolTov(Заказчик) [Количество заказов] from Заказы
...
#     );
#     GO
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION) values ('ИТ', '1-40 01 02', 'Информационные системы и
#     технологии', 'инженер-программист-системотехник' );
...
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION) values ('ИТ', '1-36 06 01', 'Полиграфическое оборудование и
#     системы обработки информации', 'инженер-электромеханик' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION) values ('ХТиТ', '1-36 01 08', 'Конструирование и производство
#     изделий из композиционных материалов', 'инженер-механик' );
...
#     хозяйства' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION) values ('ЛХФ', '1-75 02 01', 'Садово-парковое строительство',
...
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION) values ('ИЭФ', '1-25 01 07', 'Экономика и управление на
#     предприятии', 'экономист-менеджер' );
...
#     'экономист' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME,
#     QUALIFICATION) values ('ТТЛП', '1-36 05 01', 'Машины и оборудование
#     лесного комплекса', 'инженер-механик' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME,
#     QUALIFICATION) values ('ТТЛП', '1-46 01 01', 'Лесоинженерное дело',
#     'инженер-технолог' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME,
#     QUALIFICATION) values ('ТОВ', '1-48 01 02', 'Химическая технология
#     органических веществ, материалов и изделий', 'инженер-химик-технолог' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME,
#     QUALIFICATION) values ('ТОВ', '1-48 01 05', 'Химическая технология
#     переработки древесины', 'инженер-химик-технолог' );
#     insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME,
...
#     end;
#     GO
#     select * from dbo.FACULTY_REPORT(12)
#     """,
# )
#
# del db
